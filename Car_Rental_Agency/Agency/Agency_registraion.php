...
<section>
 ...
 <input type="text" class="name ele" name="name" placeholder="Enter Agency name" required>
 <input type="email" class="email ele" name="email" placeholder="youremail@email.com" required>
 <input type="number" class="name ele" name="mobile" placeholder="123456789" required>
...
if(isset($_POST['signup'])) {
    if($_POST['password']!=$_POST['confpassword']){
        ...
        $sql = "INSERT INTO agencies (agency_name, email, password,mobile) VALUES ('$name', '$email', '$password','$mobile')";
